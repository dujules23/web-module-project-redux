...
import { toggleFavorites } from '../actions/favortiesActions'
...
const MovieHeader = (props) => {
    ...
    return(<div className="table-title">
        ...
        <div className="col-sm-6 headerBar">
            <div class="btn btn-sm btn-primary"onClick={() => props.toggleFavorites()}><span>{ props.displayFavorites ? "Hide" : "Show"} Favorites</span></div>
